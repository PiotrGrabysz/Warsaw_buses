...
def test_keys_in_stops_coord(apikey: str = APIKEY, f_path: Union[None, str] = None):
    """It tests if the keys in stops coordinates (wspolrzedne przystankow) are as they should be. If Warsaw buses change
    the names of the keys or their order it will throw an error.
    If f_path parameter is given, than it reads data from file named f_path. Else, it request data from website"""
